	...
	<div class="row">
		...
		<div>
			<div class="span2 warning pull-left" style="background-color:#f5f5f5;">
				<pre><h4><?php echo L('OPERATING_TIPS');?></h4><?php echo L('EMAIL_TIPS_ONE');?><span style="color:red"><br/>123@5kcrm.com<br/>321@5kcrm.com</span><br/><?php echo L('EMAIL_TIPS_TWO');?><span style="color:red">{</span><span style="color:red">name}</span><?php echo L('INSTEAD');?><br><span style="color:red"><?php echo L('EMAIL_TIPS_TWO_NOTIC');?><br/>123@5kcrm.com,<?php echo L('ZHANGSAN');?><br/>321@5kcrm.com,<?php echo L('LISI');?></span><br/><?php echo L('EMAIL_TIPS_TWO_NOTICS');?><br/>3、<span style="color:red"><?php echo L('EMAIL_TIPS_THREE');?></span>
				</pre>
			</div>
